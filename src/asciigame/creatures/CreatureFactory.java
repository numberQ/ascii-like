...
public class CreatureFactory {
	...
	public static Creature makePlayer(List<String> messages, FieldOfView fov) {
		int maxHealth = 50, minAttack = 3, maxAttack = 10, defense = 1, visionRadius = 9, invSize = 10, maxFood = 1000;
	...
	public static Creature makeFungus() {
		int maxHealth = 5, minAttack = 1, maxAttack = 5, defense = 0, visionRadius = 0, invSize = 0, maxFood = 0;
